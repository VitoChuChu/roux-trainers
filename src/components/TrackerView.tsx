    ...
    <Box className={classes.container}>
      ...
      <Paper className={classes.paper} >
        ...
        <Box className={classes.select}>
            <FormControl>
                <InputLabel>{X.TRACKER.MODE}</InputLabel>
                <Select
                    value={state.mode}
                    onChange={handleMode}
                >
                <MenuItem value={"fs,lp"}>{X.TRACKER.WATCH_FS_TRACK_LP}</MenuItem>
                <MenuItem value={"fs,lp+dr"}>{X.TRACKER.WATCH_FS_TRACK_LP_DR}</MenuItem>
                <MenuItem value={"fb,dr"}>{X.TRACKER.WATCH_FB_TRACK_DR}</MenuItem>
                <MenuItem value={"fb,sp"}>{X.TRACKER.WATCH_FB_TRACK_SB}</MenuItem>
                <MenuItem value={"fb,ss"}>{X.TRACKER.WATCH_FB_TRACK_DR_SB}</MenuItem>
                <MenuItem value={"cross,pair"}>{X.TRACKER.WATCH_CROSS_TRACK_F2L}</MenuItem>
                </Select>
        ...
        <Box className={classes.select}>
            <FormControl>
                <InputLabel>{X.TRACKER.MOVE_COUNT}</InputLabel>
                <Select
      ...
      <Paper className={classes.paper}>
        ...
        <Button size="medium" variant="outlined" color="primary" onClick={handleClick}>
            {state.display === "hidden" ? X.COMMON.REVEAL : X.COMMON.NEXT }
        </Button>
